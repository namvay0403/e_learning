...
class Topics {
  ...
  late final String name;
  late final Null beforeTheClassNotes;
  late final Null afterTheClassNotes;
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['name'] = name;
    _data['beforeTheClassNotes'] = beforeTheClassNotes;
    _data['afterTheClassNotes'] = afterTheClassNotes;
